...
#+--- Bars RIGHT ---+
tmux set -g status-right "$battery_status$current_path$cmus_status$netspeed$git_status$wb_git_status$date_and_time #[fg=${THEME[bblack]},bg=${THEME[green]},bold] #[bold,nodim]#S #{?client_prefix,󰠠 ,#[dim]󰤂 } $hostname"
